...
## 🧩Модули и их функционал
    ...
    5.  txSync          (Bridge / Withdraw)                                          
    6.  Merkly          (Refuel во все сети из L2)
    7.  Bungee          (Refuel во все сети из zkSync)
    8.  Mute            (Свапы между стейблами и ETH + ввод и вывод ликвидности)                       
    9.  SyncSwap        (Свапы между стейблами и ETH + ввод и вывод ликвидности)                         
    10.  Maverik         (Свапы между стейблами и ETH + ввод и вывод ликвидности)             
    11. Velocore        (Свапы между стейблами и ETH)                                         
    12. XYfinance       (Свапы между стейблами и ETH)                                   
    13. Rango           (Свапы между стейблами и ETH)                                      
    14. OpenOcean       (Свапы между стейблами и ETH)                               
    15. 1inch           (Свапы между стейблами и ETH)                                                  
    16. zkSwap          (Свапы между стейблами и ETH)  
    17. Rango           (Свапы между стейблами и ETH)                                    
    18. SpaceFI         (Свапы между стейблами и ETH)   
    19. WooFI           (Свапы между стейблами и ETH)          
    20. veSync          (Свапы между стейблами и ETH)
    21. iZumi           (Свапы между стейблами и ETH)   
    22. PancakeSwap     (Свапы между стейблами и ETH)
    23. Velocore        (Свапы между стейблами и ETH)
    24. EraLend         (Ввод и вывод ликвидности + вкл/выкл collateral)        
    25. Basilisk        (Ввод и вывод ликвидности + вкл/выкл collateral)                                    
    26. ZeroLend        (Ввод и вывод ликвидности + вкл/выкл collateral)
    27. ReactorFusion   (Ввод и вывод ликвидности + вкл/выкл collateral)  
    28. ZNS             (Минт домена)
    29. ENS             (Минт домена)
    30. Safe (Gnosis)   (Создание сейфа)
    31. MailZero        (Минт Free NFT)
    32. Zerius          (Минт / бридж NFT)
    33. Tevaera         (Минт двух NFT)
    34. Omnisea         (Создание коллекции)
    35. Dmail           (Отправка сообщений)
    36. L2Telegraph     (Отправка сообщений + минт и брижд во все сети )
    37. Sending ETH to random addresses (Отправка пыли в ETH на рандомные адресса)
    38. Wrap/Unwrap ETH
