...
## 🧩Модули
    ...
    54. zkStars             (Минт рандомной NFT)
    55. Dmail               (Отправка сообщений)
    56. L2Telegraph         (Отправка сообщений + минт и брижд в/из любой сети)
    57. ETH Sender          (Отправка пыли в ETH на свой / рандомный адрес)
    58. Wrap/Unwrap ETH     (Делает врапы / анврапы ETH через офф. контракт WETH в сети)
    59. Wraps Abuser        (Делает врапы / анврапы ETH на агрегаторах, минуя офф. контракт WETH в сети)
    60. Colletor ETH        (Собирает весь баланс в ETH)
    61. Balancer ETH        (Уравнивает весь баланс в одинакове количество ETH)
    62. Random Approve      (Делает случайный апрув на контракт DEX)
    63. L2Pass Attack       (Несколько L0 refuel / бриджей NFT подряд)
    64. Merkly Attack       (Несколько L0 refuel / бриджей NFT подряд)
    65. Whale Attack        (Несколько L0 refuel / бриджей NFT подряд)
    66. Zerius Attack       (Несколько L0 refuel / бриджей NFT подряд)
