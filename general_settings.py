...
'-----------------------------------------------APPROVE CONTROL--------------------------------------------------------'
UNLIMITED_APPROVE = False       # Если True, то Включает безлимитный Approve для контракта

'------------------------------------------------HELP SOFTWARE---------------------------------------------------------'
HELP_SOFTWARE = True  # Если True, контракты агрегаторов будут переводить автору 1% от суммы свапа
