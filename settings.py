...
CEX_DEPOSIT_LIMITER = 1, (1, 5000)  # (Ограничитель баланса, (мин. сумма, макс. сумма для остатка на балансе))
...
BRIDGE_AMOUNT_LIMITER = 1, (0.1, 10)  # (Ограничитель баланса, (мин. сумма, макс. сумма для остатка на балансе))
"""
---------------------------------------------OMNI-CHAIN CONTROL---------------------------------------------------------
...
ALL_DST_CHAINS = False      # Если True, то refuel_l2pass (и прочие) попытается сделать refuel в каждую входящую сеть
...
SRC_CHAIN_MERKLY = [35, 43]         # Исходящая сеть для Merkly
...
--------------------------------------------------OMNI-CHAIN------------------------------------------------------------            
    ...
    okx_deposit_l0                   # депозит средств на биржу для сети с наибольшим балансом из STARGATE_CHAINS 
    bingx_deposit_l0                 # депозит средств на биржу для сети с наибольшим балансом из STARGATE_CHAINS 
    binance_deposit_l0               # депозит средств на биржу для сети с наибольшим балансом из STARGATE_CHAINS 
