...
CEX_BALANCE_WANTED = 1, (0, 0)    # Необходимый баланс на аккаунтах для уравнителя (make_balance_to_average)
CEX_DEPOSIT_LIMITER = 1, (1, 2)  # (Ограничитель баланса, (мин. сумма, макс. сумма для остатка на балансе))
