...
------------------------------------------------------------------------------------------------------------------------
"""
OKX_WITHDRAW_NETWORK = 21                # Сеть вывода из OKX
OKX_WITHDRAW_AMOUNT = (2.3, 2.31)  # (минимальная, максимальная) сумма для вывода из OKX (кол-во)
...
SMART_REFUEL_BATCH = False  # Если True, то smart_l2pass (и прочие) попытается сделать refuel в каждую входящую сеть
