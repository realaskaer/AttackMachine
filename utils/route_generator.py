...
AVAILABLE_MODULES_INFO = {
    ...
    smart_merkly                        : (smart_merkly, 3, 'Merkly Smart Refuel', 0, [2, 3, 4, 8, 11, 12]),
    refuel_merkly                       : (refuel_merkly, 3, 'Merkly Refuel', 0, [2, 3, 4, 8, 11, 12]),
    smart_l2pass                        : (smart_l2pass, 3, 'L2Pass Smart Refuel', 0, [2, 3, 4, 8, 11, 12]),
    ...
    zerius_refuel_google                : (zerius_refuel_google, 3, 'Zerius Google Refuel', 0, [2, 3, 4, 8, 11, 12]),
    merkly_refuel_google                : (merkly_refuel_google, 3, 'Merkly Google Refuel', 0, [2, 3, 4, 8, 11, 12]),
    l2pass_refuel_google                : (l2pass_refuel_google, 3, 'L2Pass Google Refuel', 0, [2, 3, 4, 8, 11, 12]),
    zerius_bridge_google                : (zerius_bridge_google, 3, 'Zerius Google Bridge', 0, [2, 3, 4, 8, 11, 12]),
