...
AVAILABLE_MODULES_INFO = {
    ...
    mint_and_bridge_wormhole_nft        : (mint_and_bridge_wormhole_nft, 3, 'Merkly Wormhole NFT bridge', 0, []),
    mint_and_bridge_wormhole_token      : (mint_and_bridge_wormhole_token, 3, 'Merkly Wormhole Tokens bridge', 0, []),
