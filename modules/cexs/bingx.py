...
from config import CEX_WRAPED_ID, BINGX_NETWORKS_NAME, TOKENS_PER_CHAIN
from general_settings import GLOBAL_NETWORK
from settings import (
    BINGX_WITHDRAW_NETWORK, BINGX_WITHDRAW_AMOUNT, BINGX_DEPOSIT_NETWORK, BINGX_DEPOSIT_AMOUNT
)
...
class BingX(CEX, Logger):
    ...
    async def deposit(self, deposit_data: list = None):
        ...
        if deposit_data:
            ...
            deposit_network = BINGX_DEPOSIT_NETWORK
            deposit_amount = BINGX_DEPOSIT_AMOUNT
